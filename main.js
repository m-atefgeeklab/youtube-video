  ...
  return retry(async () => {
    try {
      ...
      await new Promise((resolve, reject) => {
        ...
        downloadVideo.on("error", (err) => reject(new Error(`Error running video download command: ${err.message}`)));
      ...
      await new Promise((resolve, reject) => {
        ...
        downloadAudio.on("error", (err) => reject(new Error(`Error running audio download command: ${err.message}`)));
      ...
      await new Promise((resolve, reject) => {
        ...
        mergeProcess.on("error", (err) => reject(new Error(`Error running merge command: ${err.message}`)));
